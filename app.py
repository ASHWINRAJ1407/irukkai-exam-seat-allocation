...
def create_app(config_class=Config):
    ...
    with app.app_context():
        ...
        try:
            ...
            # If legacy subscription/payment tables exist in the database, drop them.
            # This removes `admin_settings`, `payment_submissions`, `subscription_plans`, and `subscriptions`.
